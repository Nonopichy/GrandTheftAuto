...
public class Config {
    ...
    private Plugin plugin = GrandTheftAuto.getPlugin(GrandTheftAuto.class);
    private String name;
    private File file;
    ...
    public void reloadConfig() {
        this.file = new File(GrandTheftAuto.getPlugin(GrandTheftAuto.class).getDataFolder(), getName());
